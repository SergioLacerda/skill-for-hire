...
import (
	...
	chestdomain "github.com/SergioLacerda/skill-for-hire/skills/treasure-chest/runtime/domain"
)
...
var allowedJewelEvidenceClasses = stringSet(
	chestdomain.EvidenceClassExplicit,
	chestdomain.EvidenceClassCorroboratedInference,
	chestdomain.EvidenceClassWeakInference,
	chestdomain.EvidenceClassUnknown,
)

var allowedJewelEvidenceConfidences = stringSet(
	chestdomain.ConfidenceLow,
	chestdomain.ConfidenceMedium,
	chestdomain.ConfidenceHigh,
)
